...
export default function ContactForm() {
  ...
  return (
    <section
      id="contact"
      className="bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 rounded-3xl p-8 md:p-12 relative overflow-hidden"
    >
      ...
      <div className="max-w-xl mx-auto space-y-4 text-center">
        ...
        <p className="text-gray-400 text-sm">
          Have an exciting project idea, looking for a full-stack developer, or
      ...
      <form
        onSubmit={onSubmit}
        className="max-w-xl mx-auto mt-8 space-y-4 text-left"
      >
        <div>
        ...
        {result === "Error" && (
          <div className="p-4 rounded-xl text-sm font-medium bg-rose-500/10 border border-rose-500/20 text-rose-400">
            ❌ Something went wrong or Network Blocked. Please check your
