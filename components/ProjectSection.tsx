          ...
          return (
            ...
            >
              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    {project.tags?.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs bg-gray-900 border border-gray-800 text-purple-300 px-2.5 py-1 rounded-lg"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div
                  className="flex items-center justify-between pt-4 border-t border-gray-800/40"
                  ...
                  <div className="mt-4 space-y-3 bg-gray-950/50 border border-gray-800/80 p-4 rounded-xl text-sm">
                    ...
                    <ul className="list-disc pl-4 space-y-1.5 text-gray-400">
                      <li>
                        ...
                        Strict route restrictions separating{" "}
                        <span className="text-blue-400">Contributors</span> and{" "}
                        <span className="text-purple-400">Maintainers</span>.
                      </li>
                      <li>
                        <strong className="text-gray-300">
                          Raw SQL Architecture:
                        </strong>{" "}
                        Zero ORMs used. Relational mapping resolved
                        programmatically via app-level batch data mapping.
                      </li>
                      <li>
                        <strong className="text-gray-300">
                          Secure Token Flow:
                        </strong>{" "}
                        Encrypted auth headers deploying signed stateless JWTs
                        alongside salted bcrypt hashing.
                      </li>
                    </ul>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.tags?.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs bg-purple-500/10 border border-purple-500/20 text-purple-300 px-3 py-1 rounded-lg font-medium"
                      >
                        {tag}
                      </span>
                    ))}
