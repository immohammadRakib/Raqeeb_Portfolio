    ...
    <header className="grid md:grid-cols-12 gap-12 items-center min-h-[50vh]">
      <div className="space-y-6 max-w-3xl md:col-span-7 order-2 md:order-1 text-center md:text-left">
        ...
        <p className="text-lg text-gray-400 leading-relaxed">
          Hello! I am a passionate Full-Stack Engineer focused on pushing the
          boundaries of what is possible on the web. I specialize in weaving
          clean code structures, solid databases, and seamless real-world
          digital experiences.
        </p>
        ...
        <div className="flex flex-wrap gap-4 pt-4 justify-center md:justify-start">
          <a
            href="#projects"
            className="px-6 py-3 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20 hover:scale-[1.02]"
          >
            View Projects
          </a>
          ...
          <a
            href="#contact"
            className="px-6 py-3 rounded-xl bg-gray-900 border border-gray-800 text-gray-300 font-medium hover:bg-gray-800 transition-all hover:scale-[1.02]"
          >
            Get In Touch
          </a>
        </div>
