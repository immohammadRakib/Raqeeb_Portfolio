...
export default async function HomePage() {
  ...
  // app/page.tsx এর ভেতরের defaultProjects অংশটি এভাবে আপডেট করুন:
  const defaultProjects = projects.length > 0 ? projects : [
  {
  _id: 'p2',
  title: 'DevPulse - Collaborative Issue Tracker',
  description: 'A secure backend infrastructure engineered for software engineering teams to track internal bugs and feature workflows. Implemented robust authorization guards supporting granular role-based access control (RBAC) across multiple tiers using custom Node/Express APIs. Handled relational data persistence entirely using Raw PostgreSQL query pipelines (Zero ORMs/JOINs) optimized with application-level entity batching.',
  tags: ['Node.js', 'TypeScript', 'Express.js', 'PostgreSQL', 'JWT', 'Bcrypt'],
  githubLink: 'https://github.com/immohammadRakib/Assignment_2', // এখানে আপনার গিটহাব ব্যাকএন্ড কোড লিংক দিন
  liveLink: 'https://assignment-2-nxjx.onrender.com/' // ব্যাকএন্ড প্রজেক্টের জন্য আপনি চাইলে আপনার গিটহাব লিংক বা Render API লিংক দিতে পারেন
},
  {
    _id: 'p1',
    title: 'SCHOOLING - Course Platform',
    description: 'An educational platform where users can explore diverse courses, access detailed descriptions via protected private routes, and download course curriculum PDFs. It features a premium subscription model requiring user authentication with smart redirection logic back to the intended premium content after a successful login.',
    tags: ['React', 'Firebase', 'Node.js', 'Express.js', 'MongoDB'],
    githubLink: 'https://github.com/immohammadRakib', // এখানে আপনার গিটহাব লিংক দিয়ে দিন
    liveLink: 'https://fire-router-context.web.app' // আপনার দেওয়া লাইভ সাইট লিঙ্ক
  },
];
